<x-app-layout>
    <x-slot:title>Kategori Dokumen</x-slot:title>
        ...
        <div class="card-body">
            ...
            <div class="d-sm-flex flex-sm-row-reverse justify-content-between align-items-center mb-4">
                ...
                <form action="{{ route('kategori.index') }}" method="GET" class="position-relative">
                    <input type="text" name="search" class="form-control ps-5" value="{{ request('search') }}" placeholder="Cari Kategori Dokumen ..." autocomplete="off">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title" id="exampleModalLabel">
                                            <i class="ti ti-trash me-1"></i> Hapus Data Kategori Dokumen
                                        </h1>
                                    </div>
